...
2.  **Stap 2 (Post Creatie):** User B maakt een nieuwe blogpost aan met de status 'Published'.
    ...
    *   **Whitebox Check:** Verifieer of de `Post` entiteit correct is gekoppeld aan de `User` ID in de databas.
...
| **INT-03** | Integriteit | Bij verwijdering van User B (Cascade) moeten volg-relaties verdwijnen. |
