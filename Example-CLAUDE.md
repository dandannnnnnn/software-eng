...
The name of the blogging platform is Inky

## Mistake 2

Users shouldn't have to select wether or or not they are a reader or an author, all users should be able to read/post

## Mistake 3

Make sure the author of a post can delete it
